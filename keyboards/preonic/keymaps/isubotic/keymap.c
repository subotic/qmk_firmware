 ...
 *
 * 1. Build firmware: $ make preonic/rev3:isubotic:dfu-util
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  KC_TRNS, _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______, \
...
[_META] = LAYOUT_preonic_grid( \
  S(KC_GRV), S(KC_1),   S(KC_2), S(KC_3), S(KC_4), S(KC_5), S(KC_6), S(KC_7), S(KC_8),    S(KC_9),    S(KC_0),    S(KC_RBRC), \
...
[_RAISE] = LAYOUT_preonic_grid( \
   _______, KC_F1  , A(KC_2), A(KC_3), A(KC_4), A(KC_5), A(KC_6), A(KC_7), A(KC_8), A(KC_9), A(KC_0), _______, \
 ...
 * |      | Reset|      |      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|AudOff|AGnorm|AGswap|Qwertz|STN_EN|STN_DE|      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |Voice-|Voice+|Mus on|MusOff|MidiOn|MidOff|Brite |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTZ,  STN_EN,  STN_DE,  _______, _______, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
        ...
        case STN_EN:
          if (record->event.pressed) {
            set_single_persistent_default_layer(_STN_EN);
          }
          return false;
          break;
        case STN_DE:
          if (record->event.pressed) {
            set_single_persistent_default_layer(_STN_DE);
          }
          return false;
          break;
        case LOWER:
