...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ortho_4x12(
    ...
    KC_CAPS, KC_GRV,  _______, _______, _______, KC_TRNS, _______, _______, _______, KC_QUOT, KC_EQL,  _______,
   ...
   _______, S(KC_GRV),  _______, _______, _______, _______, _______, _______, _______, KC_QUOT, KC_EQL,  _______,
